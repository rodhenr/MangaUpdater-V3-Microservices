...
using MangaUpdater.Services.Fetcher.Features.Engines;
...
public static class DependencyInjectionExtensions
{
    public static IServiceCollection AddServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<ISourceDefinitionProvider, DatabaseSourceDefinitionProvider>();
        services.AddSingleton<ISourceEngineResolver, SourceEngineResolver>();
        services.AddSingleton<IChapterExtractionService, ChapterExtractionService>();
        services.AddSingleton<ISourceRequestExecutor, SourceRequestExecutor>();
        services.AddSingleton<IScraperEngine, HtmlXPathScraperEngine>();
        services.AddSingleton<IScraperEngine, JsonApiScraperEngine>();
